/**
 * @file ColibriModule.h
 * @copyright This code is licensed under the 3-clause BSD license.\n
 *            Copyright ETH Zurich, Department of Chemistry and Applied
 * Biosciences, Reiher Group.\n See LICENSE.txt for details.
 */

#ifndef COLIBRI_MODULE_H
#define COLIBRI_MODULE_H
...
namespace Scine {
namespace Colibri {
class ColibriModule : public Core::Module {
  // Loadable Colibri Module with a list of calculators
 public:
 ...
 */
extern "C" {
const void* moduleFactory = reinterpret_cast<const void*>(reinterpret_cast<intptr_t>(&Scine::Colibri::moduleFactory));
}
#else
BOOST_DLL_ALIAS(Scine::Colibri::moduleFactory, moduleFactory)
#endif
#endif
