...
int main(int argc, char** argv) {
  ...
  timeval start, first, then, after_vci;
  ...
  try {
    ...
    if (id == 0) {
      std::cout << "Number of SP Calculations needed to construct PES from SPs: " << pes->getNumSPsForVSCF() << std::endl;
