...
int main(int /*argc*/, char** argv) {
  std::cout << "------ VSCF routine ------" << std::endl;
  ...
  try {
    ...
    parms.setPES(parms.inputPESFname_);
    std::shared_ptr<PES> pes = std::make_shared<PesQFF>();

    pes->setReferenceGeometry(parms.linForceConst_, parms.quadraticForceConst_, parms.cubicForceConst_, parms.quarticForceConst_);
    ...
    std::cout << "VSCF Energy is: " << vscfEnergy << std::endl;
    // Final operations
